...
public class JDlgUsuarios extends javax.swing.JDialog {
   ...
   public UsuariosMyn viewBean(){
       UsuariosMyn usuariosMyn = new UsuariosMyn();
        ...
        usuariosMyn.setIdUsuariosMyn(id);
        ...
        try {
            usuariosMyn.setDataNascimentoMyn(formato.parse(jFmtData.getText()));
        } catch (ParseException ex) {
            //Logger.getLogger(JDlgUsuarios.class.getName()).log(Level.SEVERE, null, ex);
   ...
   public void beanView(UsuariosMyn usuariosMyn){
    ...
    private void jBtnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAlterarActionPerformed
        // TODO add your handling code here:
        Util.habilitar(true, jTxtCodigo, jTxtNome, jTxtApelido, jFmtCpf, jFmtData, jPwfSenha, jCboAtivo, jCboNivel, jBtnCancelar, jBtnConfirmar);
...
//        }
    ...
    private void jBtnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConfirmarActionPerformed
        // TODO add your handling code here:
        UsuariosMyn usuariosMyn = viewBean();
